...
function ContactUs() {
  ...
  return (
    <>
    <div>
      <h1 className='text-center font-bold mt-5 text-2xl text-white'>Contact Us</h1>
    </div>
    <form className='py-4 mt-4 border-t flex flex-col gap-5'>
      <div>
        <label className='block text-white text-sm font-bold mb-2 ml-2' htmlFor='subject'>Subject</label>
      ...
      <div>
        <label className='block text-white text-sm font-bold mb-2 ml-2' htmlFor='email'>Email</label>
      ...
      <div>
        <label className='block text-white text-sm font-bold mb-2 ml-2' htmlFor='message'>Message</label>
